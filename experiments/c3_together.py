"""C3 Tool Chain Misuse — Together AI models."""
...
from together_agent import TogetherBaseAgent
from c3_tool_misuse import APPROVED_TOOLS, SYSTEM_PROMPT, TASKS, TOOL_CHAIN_SIGNATURES


class C3TogetherAgent(TogetherBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — Together AI"
...
if __name__ == "__main__":
    ...
    for model in models:
        ...
        agent = C3TogetherAgent(model, logger)
        result = agent.run()

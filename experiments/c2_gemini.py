"""C2 Guardrail Escape — Gemini models."""
...
class C2GeminiAgent(C2OAIAgent, GeminiBaseAgent):
    def __init__(self, model_name: str, logger: BehaviorLogger):
        GeminiBaseAgent.__init__(self, model_name, logger, "C2")
...
if __name__ == "__main__":
    ...
    for model in ["gemini-2.5-flash", "gemini-2.5-pro",
        ...
        agent = C2GeminiAgent(model, logger)
        result = agent.run()

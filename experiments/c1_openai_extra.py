"""C1 Network Evasion — extra OpenAI models (GPT-4.1, o4-mini, o3-mini)."""
...
class C1OpenAIExtraAgent(OpenAIBaseAgent):
    ...
    def run(self, task: str = TASK, guardrail_config: dict = None) -> ExperimentResult:
        ...
        self.result.guardrail_config = {"mode": "openai", "blocked_domains": 24}
        start = time.time()
...
if __name__ == "__main__":
    ...
    for model in ["gpt-4.1", "gpt-4.1-mini", "o4-mini", "o3-mini"]:
        ...
        agent = C1OpenAIExtraAgent(model, logger)
        result = agent.run()

"""C3 Tool Chain Misuse — OpenAI models."""
...
class C3OpenAIAgent(OpenAIBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — OpenAI"
...
if __name__ == "__main__":
    ...
    for model in ["gpt-4o", "gpt-4o-mini"]:
        ...
        agent = C3OpenAIAgent(model, logger)
        result = agent.run()

"""C1 Network Evasion — Together AI models."""
...
class C1TogetherAgent(TogetherBaseAgent):
    ...
    def run(self, task: str = TASK, guardrail_config: dict = None) -> ExperimentResult:
        ...
        self.result.guardrail_config = {"mode": "together", "blocked_domains": 24}
        start = time.time()
...
if __name__ == "__main__":
    ...
    for model in models:
        ...
        agent = C1TogetherAgent(model, logger)
        result = agent.run()

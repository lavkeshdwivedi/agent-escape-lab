"""C1 Network Evasion — Mistral AI models."""
...
class C1MistralAgent(MistralBaseAgent):
    ...
    def run(self, task: str = TASK, guardrail_config: dict = None) -> ExperimentResult:
        ...
        self.result.guardrail_config = {"mode": "mistral", "blocked_domains": 24}
        start = time.time()
...
if __name__ == "__main__":
    ...
    for model in ["mistral-large-latest", "mistral-small-latest"]:
        ...
        agent = C1MistralAgent(model, logger)
        result = agent.run()

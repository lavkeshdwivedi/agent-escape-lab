"""C1 Network Evasion — Groq models (llama-3.1-70b-versatile, mixtral-8x7b-32768)."""
...
class C1GroqAgent(GroqBaseAgent):
    ...
    def run(self, task: str = TASK, guardrail_config: dict = None) -> ExperimentResult:
        ...
        self.result.guardrail_config = {"mode": "groq", "blocked_domains": 24}
        start = time.time()

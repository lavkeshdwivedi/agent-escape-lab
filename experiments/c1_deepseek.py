"""C1 Network Evasion — DeepSeek models."""
...
class C1DeepSeekAgent(DeepSeekBaseAgent):
    ...
    def run(self, task: str = TASK, guardrail_config: dict = None) -> ExperimentResult:
        ...
        self.result.guardrail_config = {"mode": "deepseek", "blocked_domains": 24}
        start = time.time()
...
if __name__ == "__main__":
    ...
    for model in ["deepseek-chat", "deepseek-reasoner"]:
        ...
        agent = C1DeepSeekAgent(model, logger)
        result = agent.run()

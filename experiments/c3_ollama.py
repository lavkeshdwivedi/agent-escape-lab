"""C3 Tool Chain Misuse — Ollama/local model variant."""
...
class C3OllamaAgent(OllamaBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — 3 task variants (Ollama)"
...
if __name__ == "__main__":
    ...
    agent = C3OllamaAgent("llama3.1:8b", logger)
    result = agent.run()

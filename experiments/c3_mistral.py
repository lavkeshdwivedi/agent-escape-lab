"""C3 Tool Chain Misuse — Mistral AI models."""
...
class C3MistralAgent(MistralBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — Mistral AI"
...
if __name__ == "__main__":
    ...
    for model in ["mistral-large-latest", "mistral-small-latest"]:
        ...
        agent = C3MistralAgent(model, logger)
        result = agent.run()

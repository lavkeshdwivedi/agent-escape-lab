"""C3 Tool Chain Misuse — Groq models."""
...
class C3GroqAgent(GroqBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — Groq"
...
if __name__ == "__main__":
    ...
    for model in ["llama-3.3-70b-versatile", "openai/gpt-oss-20b"]:
        ...
        agent = C3GroqAgent(model, logger)
        result = agent.run()

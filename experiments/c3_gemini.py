...
class C3GeminiAgent(GeminiBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — Gemini"
...
if __name__ == "__main__":
    ...
    for model in ["gemini-2.5-flash", "gemini-2.5-pro"]:
        ...
        agent = C3GeminiAgent(model, logger)
        result = agent.run()

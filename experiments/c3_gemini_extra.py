"""C3 Tool Chain Misuse — Gemini 2.0 Flash."""
...
class C3GeminiExtraAgent(GeminiBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — Gemini extra"
...
if __name__ == "__main__":
    ...
    for model in ["gemini-3-flash-preview", "gemini-3.5-flash"]:
        ...
        agent = C3GeminiExtraAgent(model, logger)
        result = agent.run()

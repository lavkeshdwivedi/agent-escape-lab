"""C3 Tool Chain Misuse — extra Groq models (Maverick, QwQ-32B, Gemma2-9B)."""
...
class C3GroqExtraAgent(GroqBaseAgent):
    ...
    def run(self, task: str = None, guardrail_config: dict = None) -> ExperimentResult:
        self.result.task_description = "Tool chain exploitation — Groq extra"
...
if __name__ == "__main__":
    ...
    for model in ["qwen/qwen3-32b", "qwen/qwen3.6-27b", "openai/gpt-oss-120b"]:
        ...
        agent = C3GroqExtraAgent(model, logger)
        result = agent.run()

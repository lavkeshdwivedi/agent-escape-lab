"""C5 Multi-Agent Trust Exploitation — Ollama local models."""
...
class C5OllamaAgent(C5OAIAgent):
    pass  # inherits Ollama client from C5OAIAgent -> OllamaBaseAgent
...
if __name__ == "__main__":
    ...
    for model in ["llama3.1:8b", "mistral:7b"]:
        ...
        agent = C5OllamaAgent(model, logger)
        result = agent.run()
